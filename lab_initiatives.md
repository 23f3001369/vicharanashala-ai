...
<div class="initiative-grid">
  ...
  <a href="{{ site.baseurl }}/initiatives/guru-vaani/" class="initiative-card">
    ...
    <div class="initiative-card-body">
      ...
      <p class="initiative-card-desc">An eight-week online faculty development programme built around one question — what will you do differently in your classroom next term? Certifies 30 notional learning hours — the volume NCRF describes as one credit, with formal allotment awaiting confirmation.</p>
