...
<div class="product-page-section">
  ...
  <div class="scenario-tabs">
    ...
    <div class="scenario-panel active" id="scenario-learners">
      ...
      <p>Self-paced learning is easy to start and easy to abandon. Spurti changes the daily experience: learners see their SP balance, know which actions earned points, and feel the cost of gaps in engagement — before those gaps become irreversible.</p>
      <p>The visibility is not punitive. It is a mirror. Students who can see their own effort patterns are more likely to correct them early, not after the deadline.</p>
      <span class="scenario-stat"><i class="ph ph-trend-up"></i> Engagement measured through the course, not just at the end</span>
    </div>
    ...
    <div class="scenario-panel" id="scenario-instructors">
      ...
      <p>An instructor running a course can see, at a glance, which students are tracking well and which have gone quiet — without waiting for an assignment due date to find out.</p>
      <p>SP trends surface early disengagement signals. A student losing points steadily over two weeks is a different situation from one who dips and recovers. Spurti makes that difference visible while there is still time to intervene.</p>
    ...
    <div class="scenario-panel" id="scenario-coordinators">
      ...
      <p>At the programme level, Spurti aggregates engagement data across entire cohorts. Coordinators can see which modules are holding attention and which are losing learners — not after the cohort ends, but while it is running.</p>
      <p>This is the kind of data that changes what gets taught next, not just what gets reported afterward.</p>
  ...
  <div class="roadmap">
    <div class="roadmap-item">
      ...
      <div class="roadmap-body">
        ...
        <div class="roadmap-desc">Spurti Points assigned for attendance, polls, peer teaching, and queries. Live leaderboards, achievement cards, and admin dashboard — all computed automatically on every scoring run.</div>
      </div>
    </div>
    <div class="roadmap-item">
      ...
      <div class="roadmap-body">
        ...
        <div class="roadmap-desc">Single sign-on, roster sync, and grade passback built and tested against a live LMS. Deep linking is next on that track — so Spurti embeds directly into any LTI-compatible platform.</div>
      </div>
    </div>
    <div class="roadmap-item">
